...
// if always-listening: wake-word doesn't detecting

// этот класс нужен был для прослушивания - постоянного доступа к микрофону с согласия юзера и выполнению команд без необходимости называть имя ассиста.